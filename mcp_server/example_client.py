...
async def main():
    ...
    async with FastMCPClient() as client:
        ...
        await client.connect_stdio(["python", "mcp_server/server.py"])
        ...
        result = await client.call_tool("get_resource_types")
        ...
        result = await client.call_tool("list_resources", {"resource_type": "namespace", "limit": 5})
        ...
        result = await client.call_tool("get_resource", {"resource_type": "namespace", "name": "default"})
        ...
        result = await client.call_tool("list_resources", {"resource_type": "pod", "namespace": "default"})
...
data:
  ...
  key2: value2
"""
        result = await client.call_tool("apply_yaml", {"yaml_content": yaml_content})
        ...
        result = await client.call_tool(
            "get_resource_events", {"resource_type": "Pod", "namespace": "default", "limit": 5}
        )
