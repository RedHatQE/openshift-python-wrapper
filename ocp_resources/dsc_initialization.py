    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            monitoring(Dict[Any, Any]): Enable monitoring on specified namespace
              ...
              FIELDS:
                 managementState	<string>
                   ...
                   the component if it is safe to do so. - "Removed" : the operator is
                   actively managing the component and will not install it, or if it is
                   installed, the operator will try to remove it.
            ...
            trusted_cabundle(Dict[Any, Any]): When set to `Managed`, adds odh-trusted-ca-bundle Configmap to all
