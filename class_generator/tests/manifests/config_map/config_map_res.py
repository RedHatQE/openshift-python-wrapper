...
class ConfigMap(NamespacedResource):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        """
        Args:
            binary_data(Dict[str, Any]): BinaryData contains the binary data. Each key must consist of alphanumeric
            ...
            data(Dict[str, Any]): Data contains the configuration data. Each key must consist of alphanumeric
            ...
            immutable(bool): Immutable, if set to true, ensures that data stored in the ConfigMap cannot
