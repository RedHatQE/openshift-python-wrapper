        ...
        **kwargs: Any,
        ...
        Args:
            ...
            tolerations (list[Any]): effect enum: NoExecute, NoSchedule, PreferNoSchedule key operator
              enum: Equal, Exists, Gt, Lt tolerationSeconds value.
            ...
            volumes (list[Any]): awsElasticBlockStore fsType partition readOnly volumeID azureDisk
              ...
              maxExpirationSeconds signerName userAnnotations secret items key
            ...
            workload_ref (dict[str, Any]): name podGroup podGroupReplicaKey.
    ...
    def to_dict(self) -> None:
        ...
        if not self.kind_dict and not self.yaml_file:
            ...
            if self.workload_ref is not None:
                _spec["workloadRef"] = self.workload_ref
