...
class TestClusterResourceQuota:
    ...
    def test_create_clusterresourcequota(self, clusterresourcequota):
    ...
    def test_get_clusterresourcequota(self, clusterresourcequota):
    ...
    def test_update_clusterresourcequota(self, clusterresourcequota):
