...
class TestVirtualMachineInstancePreset:
    ...
    def test_create_virtualmachineinstancepreset(self, virtualmachineinstancepreset):
    ...
    def test_get_virtualmachineinstancepreset(self, virtualmachineinstancepreset):
    ...
    def test_update_virtualmachineinstancepreset(self, virtualmachineinstancepreset):
    ...
    def test_delete_virtualmachineinstancepreset(self, virtualmachineinstancepreset):
