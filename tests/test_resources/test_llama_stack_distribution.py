...
class TestLlamaStackDistribution:
    ...
    def test_create_llamastackdistribution(self, llamastackdistribution):
    ...
    def test_get_llamastackdistribution(self, llamastackdistribution):
    ...
    def test_update_llamastackdistribution(self, llamastackdistribution):
