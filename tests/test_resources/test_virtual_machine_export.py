...
class TestVirtualMachineExport:
    ...
    def test_create_virtualmachineexport(self, virtualmachineexport):
    ...
    def test_get_virtualmachineexport(self, virtualmachineexport):
    ...
    def test_update_virtualmachineexport(self, virtualmachineexport):
    ...
    def test_delete_virtualmachineexport(self, virtualmachineexport):
