...
class TestVolumeSnapshotClass:
    ...
    @pytest.fixture(scope="class")
    def volumesnapshotclass(self, client):
    ...
    def test_create_volumesnapshotclass(self, volumesnapshotclass):
    ...
    def test_delete_volumesnapshotclass(self, volumesnapshotclass):
