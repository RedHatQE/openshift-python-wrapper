...
class TestUserDefinedNetwork:
    ...
    def test_create_userdefinednetwork(self, userdefinednetwork):
    ...
    def test_delete_userdefinednetwork(self, userdefinednetwork):
