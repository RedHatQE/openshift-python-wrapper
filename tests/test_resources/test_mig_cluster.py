...
class TestMigCluster:
    ...
    def migcluster(self, client):
        return MigCluster(
            ...
            namespace="default",
            is_host_cluster="test-is_host_cluster",
        )

    def test_create_migcluster(self, migcluster):
    ...
    def test_delete_migcluster(self, migcluster):
