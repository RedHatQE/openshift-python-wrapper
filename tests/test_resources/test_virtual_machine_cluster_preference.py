...
class TestVirtualMachineClusterPreference:
    ...
    def test_create_virtualmachineclusterpreference(self, virtualmachineclusterpreference):
    ...
    def test_get_virtualmachineclusterpreference(self, virtualmachineclusterpreference):
    ...
    def test_update_virtualmachineclusterpreference(self, virtualmachineclusterpreference):
