...
POD_RES = {
    ...
    "SPEC": [
        ...
        ("host_i_p_c", "host_i_p_c: Option[bool] = None", False),
        ("host_network", "host_network: Option[bool] = None", False),
        ("host_p_i_d", "host_p_i_d: Option[bool] = None", False),
        ...
        ("set_hostname_as_f_q_d_n", "set_hostname_as_f_q_d_n: Option[bool] = None", False),
