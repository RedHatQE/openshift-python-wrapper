...
POD_RES = {
    ...
    "SPEC": [
        ("active_deadline_seconds", "active_deadline_seconds: Optional[int] = None", False, "int"),
        ("affinity", "affinity: Optional[Dict[str, Any]] = None", False, "Dict[Any, Any]"),
        ("automount_service_account_token", "automount_service_account_token: Optional[bool] = None", False, "bool"),
        ("containers", "containers: Optional[List[Any]] = None", False, "List[Any]"),
        ("dns_config", "dns_config: Optional[Dict[str, Any]] = None", False, "Dict[Any, Any]"),
        ("dns_policy", 'dns_policy: Optional[str] = ""', False, "str"),
        ("enable_service_links", "enable_service_links: Optional[bool] = None", False, "bool"),
        ("ephemeral_containers", "ephemeral_containers: Optional[List[Any]] = None", False, "List[Any]"),
        ("host_aliases", "host_aliases: Optional[List[Any]] = None", False, "List[Any]"),
        ...
        ("image_pull_secrets", "image_pull_secrets: Optional[List[Any]] = None", False, "List[Any]"),
        ("init_containers", "init_containers: Optional[List[Any]] = None", False, "List[Any]"),
        ("node_name", 'node_name: Optional[str] = ""', False, "str"),
        ("node_selector", "node_selector: Optional[Dict[str, Any]] = None", False, "Dict[Any, Any]"),
        ("os", "os: Optional[Dict[str, Any]] = None", False, "Dict[Any, Any]"),
        ("overhead", "overhead: Optional[Dict[str, Any]] = None", False, "Dict[Any, Any]"),
        ("preemption_policy", 'preemption_policy: Optional[str] = ""', False, "str"),
        ("priority", "priority: Optional[int] = None", False, "int"),
        ("priority_class_name", 'priority_class_name: Optional[str] = ""', False, "str"),
        ("readiness_gates", "readiness_gates: Optional[List[Any]] = None", False, "List[Any]"),
        ("resource_claims", "resource_claims: Optional[List[Any]] = None", False, "List[Any]"),
        ...
        ("scheduling_gates", "scheduling_gates: Optional[List[Any]] = None", False, "List[Any]"),
        ("security_context", "security_context: Optional[Dict[str, Any]] = None", False, "Dict[Any, Any]"),
        ("service_account", 'service_account: Optional[str] = ""', False, "str"),
        ("service_account_name", 'service_account_name: Optional[str] = ""', False, "str"),
        ("set_hostname_as_fqdn", "set_hostname_as_fqdn: Optional[bool] = None", False, "bool"),
        ("share_process_namespace", "share_process_namespace: Optional[bool] = None", False, "bool"),
        ("subdomain", 'subdomain: Optional[str] = ""', False, "str"),
        ("termination_grace_period_seconds", "termination_grace_period_seconds: Optional[int] = None", False, "int"),
        ("tolerations", "tolerations: Optional[List[Any]] = None", False, "List[Any]"),
        ("topology_spread_constraints", "topology_spread_constraints: Optional[List[Any]] = None", False, "List[Any]"),
...
DEPLOYMENT_RES = {
    ...
    "SPEC": [
        ...
        ("progress_deadline_seconds", "progress_deadline_seconds: Optional[int] = None", False, "int"),
        ("replicas", "replicas: Optional[int] = None", False, "int"),
        ("revision_history_limit", "revision_history_limit: Optional[int] = None", False, "int"),
        ("selector", "selector: Optional[Dict[str, Any]] = None", True, "Dict[Any, Any]"),
        ("strategy", "strategy: Optional[Dict[str, Any]] = None", False, "Dict[Any, Any]"),
        ("template", "template: Optional[Dict[str, Any]] = None", True, "Dict[Any, Any]"),
    ],
}
